...
agent_communication:
  ...
  - agent: "main"
    message: "FIXED: KML/GeoJSON import functionality. User reported it wasn't working. Implemented proper toGeoJSON library usage for KML parsing, enhanced geometry handling to support all types (Point, LineString, Polygon, Multi*), added error handling, and improved user feedback. Points import as markers, lines/polygons import as drawings. Map auto-fits to imported data."